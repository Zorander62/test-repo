                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="?a=view_prescription&id=<?php echo $prescription['prescription_id']; ?>" class="btn btn-sm btn-info">
                                                <i class="ni ni-eye"></i> View
                                            </a>
                                            <a href="?a=update_prescription&id=<?php echo $prescription['prescription_id']; ?>" class="btn btn-sm btn-warning">
                                            ...
                                            <form method="POST" action="" onsubmit="return confirm('Are you sure you want to delete this prescription?');">
                                                ...
                                                <button type="submit" name="delete" class="btn btn-danger">Delete Prescription</button>
                                            </form>
