        ...
        <div class="col-lg-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="?a=manage_inventory" class="btn btn-primary">View Inventory</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="?a=prescriptions_pharmacy" class="btn btn-primary">Manage Prescriptions</a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- <button class="btn btn-primary" >Add New Medication</button> -->
                    <a class="btn btn-secondary" href="?a=prescriptions_pharmacy">Manage Prescriptions</a>
                </div>
            </div>
        </div>
    </div>
